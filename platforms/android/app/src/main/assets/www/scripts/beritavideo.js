$.getJSON('https://adm982.kabaroto.com/api/post?rpp=20&page=1&category=39', function(data) {
...
function appendData1() {
    page++;
    console.log(page);
    $.getJSON('https://adm982.kabaroto.com/api/post?rpp=20&category=39&page=' + page, function(data) {
        for(var i=0;i<data.data.length;i++){
            var my = data.data[i].cover,
            replacement = '_160x160.';
            var str = my.replace(/.([^.]*)$/, replacement + '$1');
